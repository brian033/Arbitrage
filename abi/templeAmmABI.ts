const templeAbi = [
    {
        inputs: [
            ...
            { internalType: "address", name: "_defendStable", type: "address" },
        ],
    ...
    {
        inputs: [{ internalType: "address", name: "_defendStable", type: "address" }],
    ...
    {
        inputs: [{ internalType: "address", name: "_templeTreasury", type: "address" }],
        name: "setTreasury",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
